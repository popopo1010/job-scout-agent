# 電気工事施工管理人材紹介システム 要件定義書

## 1. 概要

### 1.1 目的

CA（キャリアアドバイザー）が電気工事施工管理技士の転職支援を行う際の営業通話音声データを直接格納し、自動的に文字起こし・分析・フィードバック生成を行うシステムを構築する。

### 1.2 背景

電気工事施工管理技士は、電気工事の施工計画の作成、工程管理、安全管理、品質管理等を担当する重要な資格である。FY26の目標として「施工管理人材紹介のPMF達成」が掲げられており、電気工事士に続く第二の柱として位置づけられている。
...
- **保存場所**: `data/audio_ecm/transcripts/`
...
- 音声ファイル処理の各ステップのログ
- エラー発生時の詳細ログ
- 保存場所: `logs/audio_ecm_processing.log`
...
- **1級電気工事施工管理技士**: 大規模工事の施工管理を担当する資格
- **2級電気工事施工管理技士**: 中規模工事の施工管理を担当する資格
