...
CA（キャリアアドバイザー）が施工管理技士（建築、土木、電気工事、管工事、造園、建設機械等）の転職支援を行う際の営業通話音声データを直接格納し、自動的に文字起こし・分析・フィードバック生成を行うシステムを構築する。

### 1.2 背景

施工管理技士は、建設工事の施工計画の作成、工程管理、安全管理、品質管理等を担当する重要な資格である。FY26の目標として「施工管理人材紹介のPMF達成」が掲げられており、電気工事士に続く第二の柱として位置づけられている。
...
- **詳細**:
  - 施工管理関連の専門用語辞書
    - 施工管理、工程管理、安全管理、品質管理
    - 1級/2級施工管理技士（各種別）
    - 建築、土木、電気工事、管工事、造園、建設機械関連の専門用語
  - CA名、会社名などの固有名詞辞書
  - 句読点の自動補完
  - 話者識別（CAと求職者の区別）

#### F-CM-009: 文字起こし結果の編集機能
- **優先度**: 低
...
- **保存場所**: `data/audio_cm/transcripts/`
...
- 音声ファイル処理の各ステップのログ
- エラー発生時の詳細ログ
- 保存場所: `logs/audio_cm_processing.log`
...
- **1級施工管理技士**: 大規模工事の施工管理を担当する資格
- **2級施工管理技士**: 中規模工事の施工管理を担当する資格
- **施工管理技士の種別**: 建築、土木、電気工事、管工事、造園、建設機械
...
- [音声データフィードバックシステム 要件定義](./09-audio-feedback-requirements.md)
- [電気工事施工管理人材紹介システム 要件定義](./10-electrical-construction-management-requirements.md)
- [使用定義書（仕様定義書）](./00-specification.md)
